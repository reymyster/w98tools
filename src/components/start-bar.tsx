...
// would break the menu look. The roles already replace list semantics, so
// divs (not ul/li) are the correct host elements. Enter/Space is handled
// here since divs have no native activation.
const activateOnKey =
      ...
      <div id="start-menu" className="windows-box-shadow">
        ...
        <div className="my-0 pl-10" role="menu">
          <div
            ...
            onKeyDown={activateOnKey(() => openWindow("Help"))}
          >
            <span className="!text-base !subpixel-antialiased !font-sans cursor-pointer inline-flex items-center">
              <img
                alt=""
                className="mr-2 w-8"
          ...
          <div
            ...
            onKeyDown={activateOnKey(() => openWindow("SearchReplace"))}
          >
            <span className="!text-base !subpixel-antialiased !font-sans cursor-pointer inline-flex items-center">
              <img
                alt=""
          ...
          >
            ...
            <div
              className="windows-box-shadow hidden group-hover:block w-32 absolute top-2 left-[calc(100%_-_6px)] bg-[silver] list-none m-0 p-0"
              role="menu"
            >
              <div
                ...
                onKeyDown={activateOnKey(() => openWindow("OCR"))}
              >
                Image OCR
              </div>
              <div
          ...
          <div
            ...
            onKeyDown={activateOnKey(() => openWindow("PrettifyJson"))}
          >
            <span className="!text-base !subpixel-antialiased !font-sans cursor-pointer inline-flex items-center">
              <img
                alt=""
          ...
          <div
            ...
            tabIndex={0}
            onClick={onReset}
            onKeyDown={activateOnKey(onReset)}
          >
            <span className="!text-base !subpixel-antialiased !font-sans cursor-pointer inline-flex items-center">
              <img
                alt=""
